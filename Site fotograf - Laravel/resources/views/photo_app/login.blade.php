              ...
              <div class="app-form">
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="app-form-group">
                      ...
                      <x-input id="email" class="app-form-control" placeholder="EMAIL" type="email" name="email" :value="old('email')"  />
                  </div>
                  ...
                  <div class="block mt-4">
                      <label for="remember_me" class="app-form-control" style="border-bottom: none!important;">
                  ...
                  <div class="flex items-center justify-end mt-2 mb-2">
                      @if (Route::has('password.request'))
                          <a class="app-form-control" style="width: auto;border-bottom: none!important;color: inherit;text-decoration: none!important;" href="{{ route('password.request') }}">
