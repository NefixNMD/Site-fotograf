          ...
          <div class="app-form">
            <form method="POST" action="/add_product" enctype="multipart/form-data">
              ...
              <div class="app-form-group">
                  ...
                  <x-input id="name" class="app-form-control" placeholder="PRODUCT NAME" type="name" name="name"  />
              </div>
              <div class="app-form-group">
                <textarea rows = "5" class="app-form-control" cols = "60" placeholder="PRODUCT DESCRIPTION" name="description" id="description"></textarea>
            </div>
            <div class="app-form-group">
      
              <x-input id="price" class="app-form-control" placeholder="PRODUCT PRICE" type="number" step="0.01" name="price"  />
          </div>
          <div class="app-form-group">
            <div>
              @php
