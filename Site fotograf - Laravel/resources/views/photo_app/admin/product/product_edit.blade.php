          ...
          <div class="app-form">
            <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
              ...
              <div class="app-form-group">
                  ...
                  <x-input id="name" class="app-form-control" placeholder="CATEGORY NAME" type="name" name="name" value="{{ $product->name }}"  />
              </div>

              <x-input id="description" class="app-form-control" placeholder="PRODUCT DESCRIPTION" type="description" name="description" value="{{ $product->description }}" />
            </div>
            <div class="app-form-group">
      
              <x-input id="price" class="app-form-control" placeholder="PRODUCT PRICE" type="number" step="0.01" name="price"  value="{{ $product->price }}"/>
          </div>
          <div class="app-form-group">
            <div>
              @php
              ...
              <div class="app-form-group">
                <img style="width: auto; height: 15vh" src="{{ Storage::url($product->image) }}">
