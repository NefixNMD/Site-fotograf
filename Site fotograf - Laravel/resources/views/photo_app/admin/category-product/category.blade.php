...
<body class="imd">
  ...
  <div class="mainHolder">
    <h1>Category</h1>
    <br>
    <button class="bxtn mb-5"><a href="/create_product_category" style="color: white;text-decoration: none;">Add new Category</a></button>
    <br>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-label="Update Category">
            <button class="bxtn bxtn2"><a href="{{ route('product_categories.edit', $cat->id) }}" style="color: white;text-decoration: none;">Edit</a></button></td>
          <td data-label="Delete Category">
            <form
            method="POST"
            action="{{ route('product_categories.destroy', $cat->id) }}"
